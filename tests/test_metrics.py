...
def test_metrics_for_trades_without_fee():
    ...
    assert stats['ratio_avg_win_loss'] !=  stats['ratio_avg_win_loss']
    ...
    assert stats['average_loss'] != stats['average_loss'] 
    ...
    assert stats['average_losing_holding_period'] !=  stats['average_losing_holding_period']
